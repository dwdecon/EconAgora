  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="inline-flex items-center justify-center rounded-full border border-white/10 p-2.5 text-white/80 transition-all duration-300 hover:border-white/30 hover:bg-white/5 hover:text-white"
      >
        <svg
          className="h-4 w-4"
          viewBox="0 0 24 24"
      ...
      {/* Dropdown */}
      <div
        className="absolute right-0 mt-3 min-w-[140px] origin-top-right overflow-hidden rounded-2xl border border-white/[0.08] bg-[#111113]/90 shadow-[0_16px_48px_rgba(0,0,0,0.6)] backdrop-blur-2xl"
        style={{
          opacity: open ? 1 : 0,
