#!/usr/bin/env tsx
/**
 * Regenerate all cover images with force option
 * Usage:
 *   tsx scripts/content-pipeline/regenerate-covers.ts [--force]
 *
 * Options:
 *   --force  Regenerate all covers even if they exist
 */
...
async function regenerateCovers(force = false): Promise<void> {
  console.log(`🔍 Scanning blog posts${force ? " (force mode)" : ""}...\n`);
...
if (require.main === module) {
  ...
  regenerateCovers(force).catch(console.error);
}

export { regenerateCovers };
